...
type Props<T extends BaseModel> = { inputData: Omit<T, keyof BaseModel> & { id?: string, createdAt?: number, updatedAt?: number, deletedAt?: number | null }, collectionName: string }
